...
test("due date for the same day", () => {
    expect(calculateDueDate(new Date('2023-11-15T13:10:00'), 3)).toBe(new Date('2023-11-15T16:10:00'));
});

test("due date for multiple days", () => {
    expect(calculateDueDate(new Date('2023-11-15T13:10:00'), 10)).toBe(new Date('2023-11-16T15:10:00'));
});

test("due date for non-working days", () => {
    expect(calculateDueDate(new Date('2023-11-15T13:10:00'), 24)).toBe(new Date('2023-11-20T13:10:00'));
});
...
test("the turnaround can't be negative", () => {
    expect(() => calculateDueDate(new Date('2023-11-15T17:10:00'), -10))
